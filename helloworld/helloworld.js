...
helloworld.start = function(){
	...
	var director = new lime.Director(document.body,1024,768),
		...
		dest = new lime.Label().setSize(50,50).setFontSize(30).setText('x'),
	    target = new lime.Layer().setPosition(512,384),
        circle = new lime.Circle().setSize(50,50).setFill(255,150,0),
        lbl = new lime.Label().setSize(160,50).setFontSize(30).setText('#'),
        title = new lime.Label().setSize(800,70).setFontSize(60).setText('Test')
    ...
    goog.events.listen(scene,['mousedown','touchstart'],function(e){
        ...
        e.swallow(['mouseup','touchend'],function(){
            target.runAction(new lime.animation.Spawn(
                ...
                new lime.animation.MoveTo(e.position.x,e.position.y)
            ));
