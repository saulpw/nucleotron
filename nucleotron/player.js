goog.provide('nucleotron.Player');
...
goog.inherits(nucleotron.Player, lime.Sprite);

nucleotron.Player.prototype.enableInteraction = function() {
...
nucleotron.Player.prototype.enableSimulation = function() {
    this.v = 0;
    this.a = 0;
};
